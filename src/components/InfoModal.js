            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600">
                  <li>Todos los productos se publican en la red Nostr (kind: 30017)</li>
                  <li>Búsqueda por tag: #nostrmarketplace</li>
                  <li>Los datos son accesibles desde cualquier cliente Nostr</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600">
                  ...
                  <li>Filtra por kind:30017 y tag:nostrmarketplace</li>
                  <li>Los productos son eventos Nostr estándar</li>
                </ul>
              </div>
            </div>
